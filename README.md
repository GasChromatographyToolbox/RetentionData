...
The non-flagged database contains 1581 entries of 345 unique substances (by CAS number) for 24 stationary phases.

The database including flagged entries contains 1872 entries of 353 unique substances (by CAS number) for 25 stationary phases.
