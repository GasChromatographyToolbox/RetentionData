...
#=begin
	...
	scatter(db.Tchar.+273.15, db.DeltaCp, xlabel="Tchar in K", ylabel="ΔCp in J mol⁻¹ K⁻¹", legend=false)
	plot!(db.Tchar.+273.15, model_ΔCp_Tchar(db.Tchar.+273.15, fit_ΔCp_Tchar.param))
	#plot!(db.Tchar.+273.15, model_ΔCp_Tchar(db.Tchar.+273.15, [-180.0, 0.63]))
	#savefig("Fit_DCp_Tchar.svg")
end=#

# ╔═╡ 2c26d819-0895-44a5-980c-6c196628d670
#fit_ΔCp_Tchar.param

# ╔═╡ bbe405ec-f1fd-493f-a691-be51e400c94a
#stderror(fit_ΔCp_Tchar)

# ╔═╡ f001854c-b19a-4229-a7de-bea93b3a0f53
#coeff_of_determination(model_ΔCp_Tchar, fit_ΔCp_Tchar, db.Tchar.+273.15, db.DeltaCp)
...
manifest_format = "2.0"
project_hash = "95fcc5baf9249caf2f6cf34d67af23c9cc0f0b64"
